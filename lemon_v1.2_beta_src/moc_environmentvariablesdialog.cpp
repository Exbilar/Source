...
static const char qt_meta_stringdata_EnvironmentVariablesDialog[] = {
    "EnvironmentVariablesDialog\0\0"
    "addButtonClicked()\0editButtonClicked()\0"
    "deleteButtonClicked()\0viewerSelectionChanged()\0"
};
...
const QMetaObjectExtraData EnvironmentVariablesDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject EnvironmentVariablesDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_EnvironmentVariablesDialog,
      qt_meta_data_EnvironmentVariablesDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &EnvironmentVariablesDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_EnvironmentVariablesDialog))
        return static_cast<void*>(const_cast< EnvironmentVariablesDialog*>(this));
