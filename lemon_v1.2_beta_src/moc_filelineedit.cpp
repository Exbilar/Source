...
static const char qt_meta_stringdata_FileLineEdit[] = {
    "FileLineEdit\0\0refreshFileList()\0"
};
...
const QMetaObjectExtraData FileLineEdit::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject FileLineEdit::staticMetaObject = {
    { &QLineEdit::staticMetaObject, qt_meta_stringdata_FileLineEdit,
      qt_meta_data_FileLineEdit, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &FileLineEdit::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FileLineEdit))
