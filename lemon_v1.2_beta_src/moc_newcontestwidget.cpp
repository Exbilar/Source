...
static const char qt_meta_stringdata_NewContestWidget[] = {
    "NewContestWidget\0\0informationChanged()\0"
    "selectContestPath()\0savingNameChanged()\0"
};
...
const QMetaObjectExtraData NewContestWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject NewContestWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_NewContestWidget,
      qt_meta_data_NewContestWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &NewContestWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_NewContestWidget))
        return static_cast<void*>(const_cast< NewContestWidget*>(this));
