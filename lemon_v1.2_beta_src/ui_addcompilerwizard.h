...
public:
    ...
    {
        AddCompilerWizard->setWindowTitle(QApplication::translate("AddCompilerWizard", "Add Compilers Wizard", 0, QApplication::UnicodeUTF8));
        stepOneLabel->setText(QApplication::translate("AddCompilerWizard", "Step I: Choose whether you want to use built-in configuration for certain compilers or customize a compiler's configuration.", 0, QApplication::UnicodeUTF8));
        customRadioButton->setText(QApplication::translate("AddCompilerWizard", "Custom Configuration", 0, QApplication::UnicodeUTF8));
        builtinRadioButton->setText(QApplication::translate("AddCompilerWizard", "Built-in Configuration (Tick the compilers you want to add)", 0, QApplication::UnicodeUTF8));
        stepTwoLabel->setText(QApplication::translate("AddCompilerWizard", "Step II: Select compiler's location to configure it.", 0, QApplication::UnicodeUTF8));
        compilerNameLabel->setText(QApplication::translate("AddCompilerWizard", "Compiler Name", 0, QApplication::UnicodeUTF8));
        compilerTypeLabel->setText(QApplication::translate("AddCompilerWizard", "Compiler Type", 0, QApplication::UnicodeUTF8));
        typeSelect->clear();
        typeSelect->insertItems(0, QStringList()
         << QApplication::translate("AddCompilerWizard", "Typical (Generate executable file)", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("AddCompilerWizard", "Interpretive (Generate byte-code file)", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("AddCompilerWizard", "Interpretive (Run source code directly)", 0, QApplication::UnicodeUTF8)
        );
        compilerLocationLabel->setText(QApplication::translate("AddCompilerWizard", "Compiler's Location", 0, QApplication::UnicodeUTF8));
        interpreterLocationLabel->setText(QApplication::translate("AddCompilerWizard", "Interpreter's Location", 0, QApplication::UnicodeUTF8));
        sourceFileExtensionsLabel->setText(QApplication::translate("AddCompilerWizard", "Source File Extensions", 0, QApplication::UnicodeUTF8));
        bytecodeFileExtensionsLabel->setText(QApplication::translate("AddCompilerWizard", "Byte-code File Extensions", 0, QApplication::UnicodeUTF8));
        defaultCompilerArgumentsLabel->setText(QApplication::translate("AddCompilerWizard", "Default Compiler's Arguments", 0, QApplication::UnicodeUTF8));
        defaultInterpreterArgumentsLabel->setText(QApplication::translate("AddCompilerWizard", "Default Interpreter's Arguments", 0, QApplication::UnicodeUTF8));
        stepTwoLabel_2->setText(QApplication::translate("AddCompilerWizard", "Step II: Select compilers' locations to configure them.", 0, QApplication::UnicodeUTF8));
        gccO2Check->setText(QApplication::translate("AddCompilerWizard", "Enable O2 Optimization", 0, QApplication::UnicodeUTF8));
        gppO2Check->setText(QApplication::translate("AddCompilerWizard", "Enable O2 Optimization", 0, QApplication::UnicodeUTF8));
        fpcO2Check->setText(QApplication::translate("AddCompilerWizard", "Enable O2 Optimization", 0, QApplication::UnicodeUTF8));
        javaMemoryLimitLabel->setText(QApplication::translate("AddCompilerWizard", "Memory Limit", 0, QApplication::UnicodeUTF8));
        javaMbLabel->setText(QApplication::translate("AddCompilerWizard", "MB", 0, QApplication::UnicodeUTF8));
        stepThreeLabel->setText(QApplication::translate("AddCompilerWizard", "Step III: Check the result and finish the wizard.", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
